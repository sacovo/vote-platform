...
def votation_list_view(request):
    ...
    return render(request, "vote/votation_list.html", {"votation_list": votations})
...
def vote_action(request, pk):
    ...
    with transaction.atomic():
        ...
        if request.method == "POST":
            ...
            if form.is_valid():
                if votation.counted_votation:
                    form.fields["ordered_input"].widget.attrs["readonly"] = "readonly"
                else:
